...
var ReactMapboxFactory = function (_a) {
    ...
    return _x = (function (_super) {
            ...
            function ReactMapboxGl() {
                ...
                _this.listeners = {};
                _this.navigationControl = new MapboxGl.NavigationControl();
            ...
            ReactMapboxGl.prototype.componentDidMount = function () {
                var _this = this;
                var _a = this.props, style = _a.style, onStyleLoad = _a.onStyleLoad, center = _a.center, pitch = _a.pitch, zoom = _a.zoom, fitBounds = _a.fitBounds, fitBoundsOptions = _a.fitBoundsOptions, bearing = _a.bearing, maxBounds = _a.maxBounds, showNavigationControls = _a.showNavigationControls;
            ...
            ReactMapboxGl.prototype.componentWillReceiveProps = function (nextProps) {
                ...
                if (didZoomUpdate ||
                    ...
                    map[mm](__assign({}, animationOptions, flyToOptions, { zoom: didZoomUpdate && nextProps.zoom ? nextProps.zoom[0] : zoom, center: didCenterUpdate ? nextProps.center : center, bearing: didBearingUpdate ? nextProps.bearing : bearing, pitch: didPitchUpdate ? nextProps.pitch : pitch }), { isReactUpdate: true });
                }
                if (!isEqual(this.props.style, nextProps.style)) {
                    map.setStyle(nextProps.style);
                }
                var handlerNames = ['doubleClickZoom', 'dragPan', 'dragRotate',
                    'touchZoomRotate', 'scrollZoom', 'boxZoom', 'keyboard'];
                for (var _i = 0, handlerNames_1 = handlerNames; _i < handlerNames_1.length; _i++) {
                    var name_1 = handlerNames_1[_i];
                    this.toggleInteractionHandler(name_1, nextProps);
                }
            ...
            ReactMapboxGl.prototype.toggleInteractionHandler = function (handlerName, nextProps) {
                var map = this.state.map;
